...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
 <tr height="90">
  ...
  <td style="background:url('<?echo $mmw[theme_img];?>/up_center.png'); padding-top: 14px; color: #9F9F9F;" align="center" valign="top"><marquee behavior="scroll" loop="-1" width="100%" scrollamount="2" hspace="0" vspace="0" scrolldelay="60" onmouseover='this.stop()' onmouseout='this.start()'><b>Welcome to Web <?echo $mmw[servername];?>! Online Game MMORPG!</b></marquee></td>
