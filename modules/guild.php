...
if(empty($guild_row[1]) || $guild_row[1]==' ') {$guild_row[1]="0";}
...
?>
	<table width="100%" class="sort-table" cellpadding="0" cellspacing="0">
          <tr>
            <td width="80" align="center" rowspan="5"><img src="decode.php?decode=<?echo $logo;?>" width="80"></td>
          ...
          <tr>
            ...
            <td><?echo preg_replace("/[^a-zA-Z0-9_ -]/",'',$guild_row[3]);?></td>
          </tr>
	<?if($guild_row[4]!=0 && $guild_row[4]!=' ') {?>
          <tr>
...
for($i=0;$i < mssql_num_rows($result);++$i) {
 ...
 $character_show = mssql_fetch_row($sql_character);
		...
		{$status[0] ='<img src='.default_img('online.gif').' width=6 height=6>';}
