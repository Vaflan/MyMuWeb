...
for($i=0; $i<139; ++$i) {
 $selected_country = '';
 if($i==$_POST['country']){$selected_country = ' selected';}
 $select_country .= '<option value="'.$i.'"'.$selected_country.'>'.country($i).'</option>';
}
?>
...
if($_GET['terms']=='agree') {
 echo '<form action="" method="post" name="register_from">
                    <table align="center" width="300" border="0" class="sort-table" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><input name="gender" type="radio" value="male"> '.mmw_lang_male.' &nbsp; <input name="gender" type="radio" value="female"> '.mmw_lang_female.'</td>
                      </tr>
                      <tr>
                        <td align="right">'.mmw_lang_security_code.'</td>
                        <td><input name="verifyinput" type="text" size="6" maxlength="8"> <img src="images/captcha.php" align="center" id="secImg"> <img src="'.default_img('refresh.gif').'" align="center" onclick="document.getElementById(\'secImg\').src=\'images/captcha.php?refresh=\'+Math.random();" title="'.mmw_lang_renew.'"></td>
                      </tr>
                      <tr>
 ...
 $terms_file = 'lang/English_terms.txt';
...
<table width="200" border="0" cellspacing="2" cellpadding="0" align="center">
  <tr>
    <td align="center"><b><big><?php echo mmw_lang_terms_of_agreement;?></big></b></td>
  </tr>
  <tr>
    <td align="center">
	<textarea name="terms" cols="60" rows="20"><?php echo substr(@file_get_contents($terms_file),3);?></textarea>
	<?php echo $rowbr;?>
	<input type="submit" value="<?php echo mmw_lang_i_agree;?>"> <input type="reset" value="<?php echo mmw_lang_i_dont;?>" onclick="top.location='?op=info';">
    </td>
  </tr>
</table>
</form>
